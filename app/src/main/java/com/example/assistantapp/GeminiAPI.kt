        ...
        withContext(Dispatchers.IO) {
            ...
            try {
                ...
                if (!hasResponse || fullResponse.isBlank()) {
                    onError("wait for server to process.thank you")
                } else {
                    Log.d("GeminiAI", "Navigation processing completed successfully")
                }
